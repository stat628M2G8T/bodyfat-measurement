...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      h6('If you have any questions please contact:'),
      h6('xhua24@wisc.edu; liu854@wisc.edu;bteng2@wisc.edu')
    )
  )
)
...
Bodyfat = function(in1,in2){
  return(-9.26942546096276+(0.714691215392542*in1)-(2.07472313684091*in2))
}
war = function(in1,in2){
  bf = -9.26942546096276+(0.714691215392542*in1)-(2.07472313684091*in2)
  temp1 = rep("",5)
  temp2 = rep("",5)
  if(bf<2){
    temp1[1]="Wrong Input"
